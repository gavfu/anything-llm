...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Chào mừng đến với PlexusAI, PlexusAI is an open-source AI tool by Mintplex Labs that turns anything into a trained chatbot you can query and chat with. PlexusAI is a BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    part2:
  ...
  llm: {
    ...
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or else PlexusAI will not function properly.",
