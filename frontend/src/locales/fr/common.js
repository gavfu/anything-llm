...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Bienvenue sur PlexusAI, un outil d'intelligence artificielle open-source créé par Mintplex Labs qui transforme n'importe quoi en un chatbot entraîné avec lequel vous pouvez interroger et discuter. PlexusAI est un logiciel BYOK (apportez vos propres clés), il n'y a donc pas d'abonnement, de frais ou de charges pour ce logiciel en dehors des services que vous souhaitez utiliser.",
    part2:
      "PlexusAI est le moyen le plus simple de regrouper des produits d'intelligence artificielle puissants tels que OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB et d'autres services dans un package soigné, sans tracas, pour augmenter votre productivité de 100x.",
    part3:
      "PlexusAI peut fonctionner totalement localement sur votre machine avec peu d'impact, vous ne remarquerez même pas qu'il est là ! Pas besoin de GPU. L'installation en cloud et sur site est également disponible.\nL'écosystème des outils d'IA devient plus puissant chaque jour. PlexusAI le rend facile à utiliser.",
  ...
  general: {
    ...
    message: {
      ...
      body: "les avantages de PlexusAI",
    },
    pfp: {
  ...
  api: {
    title: "Clés API",
    description:
      "Les clés API permettent au titulaire d'accéder et de gérer de manière programmatique cette instance PlexusAI.",
  ...
  llm: {
    ...
    description:
      "Voici les identifiants et les paramètres de votre fournisseur LLM de chat et d'intégration préféré. Il est important que ces clés soient actuelles et correctes, sinon PlexusAI ne fonctionnera pas correctement.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilisation du modèle local whisper sur des machines avec une RAM ou un CPU limités peut bloquer PlexusAI lors du traitement des fichiers multimédias.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'intégration est le processus de transformation du texte en vecteurs. Ces identifiants sont nécessaires pour transformer vos fichiers et invites en un format que PlexusAI peut utiliser pour traiter.",
    provider: {
      title: "Fournisseur d'intégration",
      description:
        "Aucune configuration n'est nécessaire lors de l'utilisation du moteur d'intégration natif de PlexusAI.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "Voici les identifiants et les paramètres de fonctionnement de votre instance PlexusAI. Il est important que ces clés soient actuelles et correctes.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protégez votre instance PlexusAI avec un mot de passe. Si vous oubliez ce mot de passe, il n'y a pas de méthode de récupération, donc assurez-vous de le sauvegarder.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Voici votre configuration pour la gestion des données et des fournisseurs tiers connectés avec PlexusAI.",
    llm: "Sélection LLM",
