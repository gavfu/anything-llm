...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PlexusAI kan arbejde med mange LLM-udbydere. Dette vil være den tjeneste, der håndterer chat.",
    },
    userSetup: {
    ...
    survey: {
      title: "Velkommen til PlexusAI",
      description:
        "Hjælp os med at gøre PlexusAI tilpasset dine behov. Valgfrit.",
      email: "Hvad er din e-mail?",
      useCase: "Hvad vil du bruge PlexusAI til?",
      useCaseWork: "Til arbejde",
      useCasePersonal: "Til personligt brug",
      useCaseOther: "Andet",
      comment: "Hvordan hørte du om PlexusAI?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Opret dit første arbejdsområde og kom i gang med PlexusAI.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Velkommen til PlexusAI, PlexusAI er et open source AI-værktøj fra Mintplex Labs, der forvandler alt til en trænet chatbot, som du kan spørge og chatte med. PlexusAI er en BYOK (bring-your-own-keys) software, så der er ingen abonnement, gebyr eller omkostninger forbundet med denne software udover de tjenester, du ønsker at bruge den med.",
    part2:
      "PlexusAI er den nemmeste måde at samle kraftfulde AI-produkter som OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB og andre tjenester i en praktisk pakke uden besvær, så du kan øge din produktivitet 100 gange.",
    part3:
      "PlexusAI kan køre helt lokalt på din maskine med minimal overhead, så du næsten ikke bemærker, at den er der! Ingen GPU er nødvendig. Installation i skyen og on-premises er også tilgængelig.\nAI-værktøjsøkosystemet bliver mere kraftfuldt hver dag. PlexusAI gør det nemt at bruge.",
  ...
  api: {
    title: "API-nøgler",
    description:
      "API-nøgler giver indehaveren mulighed for programmatisk at få adgang til og administrere denne PlexusAI-instans.",
  ...
  llm: {
    title: "LLM-præference",
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for din foretrukne LLM chat- og indlejringsudbyder. Det er vigtigt, at disse nøgler er opdaterede og korrekte, ellers vil PlexusAI ikke fungere korrekt.",
  ...
  transcription: {
    ...
    "warn-start":
      "Brug af den lokale whisper-model på maskiner med begrænset RAM eller CPU kan få PlexusAI til at gå i stå under behandling af mediefiler.",
  ...
  embedding: {
    ...
    "desc-end":
      "Indlejring er processen med at omdanne tekst til vektorer. Disse legitimationsoplysninger er nødvendige for at omdanne dine filer og prompts til et format, som PlexusAI kan bruge til behandling.",
    provider: {
      title: "Indlejringsudbyder",
      description:
        "Ingen opsætning er nødvendig, når du bruger PlexusAI's indbyggede indlejringsmotor.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for, hvordan din PlexusAI-instans vil fungere. Det er vigtigt, at disse nøgler er opdaterede og korrekte.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Beskyt din PlexusAI-instans med en adgangskode. Hvis du glemmer den, findes der ingen genoprettelsesmetode, så sørg for at gemme denne adgangskode.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Dette er din konfiguration for, hvordan tilsluttede tredjepartsudbydere og PlexusAI håndterer dine data.",
    llm: "Valg af LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Disse filer vil blive uploadet til dokumentbehandleren, der kører på denne PlexusAI-instans. Filene sendes ikke eller deles med en tredjepart.",
    },
    pinning: {
      what_pinning: "Hvad er dokumentfastlåsning?",
      pin_explained_block1:
        "Når du <b>fastlåser</b> et dokument i PlexusAI, vil vi indsætte hele dokumentets indhold i din prompt-vindue, så din LLM kan forstå det fuldt ud.",
      pin_explained_block2:
        "Dette fungerer bedst med <b>store kontekstmodeller</b> eller små filer, der er kritiske for dens vidensbase.",
      pin_explained_block3:
        "Hvis du ikke får de svar, du ønsker fra PlexusAI som standard, er fastlåsning en fremragende måde at få svar af højere kvalitet med et enkelt klik.",
      accept: "Okay, jeg har forstået",
    },
    watching: {
      what_watching: "Hvad gør det at overvåge et dokument?",
      watch_explained_block1:
        "Når du <b>overvåger</b> et dokument i PlexusAI, vil vi <i>automatisk</i> synkronisere dokumentets indhold fra dets oprindelige kilde med jævne mellemrum. Dette vil automatisk opdatere indholdet i alle arbejdsområder, hvor denne fil administreres.",
