...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PlexusAI ist mit vielen LLM-Anbietern kompatibel. Der ausgewählte Dienst wird für die Chats verwendet.",
    },
    userSetup: {
    ...
    survey: {
      title: "Willkommen bei PlexusAI",
      description:
        "Helfen Sie uns, PlexusAI an Ihre Bedürfnisse anzupassen. (Optional)",
      email: "Wie lautet Ihre E-Mail-Adresse?",
      useCase: "Wofür möchten Sie PlexusAI verwenden?",
      useCaseWork: "Beruflich",
      useCasePersonal: "Privat",
      useCaseOther: "Sonstiges",
      comment: "Wie haben Sie von PlexusAI erfahren?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Erstellen Sie Ihren ersten Workspace und starten Sie PlexusAI.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Willkommen bei PlexusAI, PlexusAI ist ein Open-Source-KI-Tool von Mintplex Labs, das alles in einen trainierten Chatbot verwandelt, den Sie abfragen und mit dem Sie chatten können. PlexusAI ist eine BYOK-Software (Bring-Your-Own-Keys), daher gibt es keine Abonnements, Gebühren oder Kosten für diese Software außerhalb der Dienste, die Sie damit nutzen möchten.",
    part2:
      "PlexusAI ist der einfachste Weg, leistungsstarke KI-Produkte wie OpenAI, GPT-4, LangChain, PineconeDB, ChromaDB und andere Dienste in einem übersichtlichen Paket ohne Aufwand zusammenzufassen, um Ihre Produktivität um das 100-fache zu steigern.",
    part3:
      "PlexusAI kann vollständig lokal auf Ihrem Computer mit geringem Overhead laufen - Sie werden nicht einmal bemerken, dass es da ist! Keine GPU erforderlich. Cloud- und On-Premises-Installation ist ebenfalls verfügbar.\nDas KI-Tool-Ökosystem wird jeden Tag leistungsfähiger. PlexusAI macht es einfach, es zu nutzen.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Sie sind auf dem Weg, ein PlexusAI-Experte zu werden!",
      dismiss: "schließen",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      heading: "Erkläre mir",
      body: "die Vorteile von PlexusAI",
    },
    pfp: {
  ...
  customization: {
    interface: {
      ...
      description: "Passen Sie die Benutzeroberfläche von PlexusAI an.",
    },
    branding: {
      title: "Branding & Whitelabeling“",
      description:
        "Individualisieren Sie Ihre PlexusAI-Instanz durch eigenes Branding.",
    },
    chat: {
      title: "Chat",
      description: "Passen Sie Ihre Chat-Einstellungen für PlexusAI an.",
      auto_submit: {
    ...
    items: {
      ...
      "welcome-messages": {
        ...
        user: "Benutzer",
        message: "Nachricht",
        assistant: "PlexusAI Chat-Assistent",
  ...
  api: {
    title: "API-Schlüssel",
    description:
      "API-Schlüssel ermöglichen es dem Besitzer, programmatisch auf diese PlexusAI-Instanz zuzugreifen und sie zu verwalten.",
  ...
  llm: {
    title: "LLM-Präferenz",
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für Ihren bevorzugten LLM-Chat- und Einbettungsanbieter. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind, sonst wird PlexusAI nicht richtig funktionieren.",
  ...
  transcription: {
    ...
    "warn-start":
      "Die Verwendung des lokalen Whisper-Modells auf Maschinen mit begrenztem RAM oder CPU kann PlexusAI bei der Verarbeitung von Mediendateien zum Stillstand bringen.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Einbettung ist der Prozess, Text in Vektoren umzuwandeln. Diese Anmeldeinformationen sind erforderlich, um Ihre Dateien und Prompts in ein Format umzuwandeln, das PlexusAI zur Verarbeitung verwenden kann.",
    provider: {
      title: "Einbettungsanbieter",
      description:
        "Bei Verwendung der nativen Einbettungs-Engine von PlexusAI ist keine Einrichtung erforderlich.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für die Funktionsweise Ihrer PlexusAI-Instanz. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Schützen Sie Ihre PlexusAI-Instanz mit einem Passwort. Wenn Sie dieses vergessen, gibt es keine Wiederherstellungsmethode, also stellen Sie sicher, dass Sie dieses Passwort speichern.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Dies ist Ihre Konfiguration dafür, wie verbundene Drittanbieter und PlexusAI Ihre Daten behandeln.",
    llm: "LLM-Auswahl",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Diese Dateien werden zum Dokumentenprozessor hochgeladen, der auf dieser PlexusAI-Instanz läuft. Diese Dateien werden nicht an Dritte gesendet oder geteilt.",
    },
    pinning: {
