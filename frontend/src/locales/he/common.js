...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "ברוכים הבאים ל-PlexusAI, PlexusAI היא כלי AI קוד פתוח מאת Mintplex Labs שהופך כל דבר לצ'אטבוט מאומן שאפשר לשאול אותו ולקיים איתו שיחה. PlexusAI הוא תוכנה מסוג BYOK (הביא את המפתחות שלך) כך שאין מנוי, עמלה או חיובים עבור התוכנה הזו מלבד השירותים שאתה רוצה להשתמש בהם.",
    part2:
      "PlexusAI היא הדרך הקלה ביותר לשלב מוצרים חזקים של AI כמו OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB ושירותים אחרים בחבילה אחת ללא מאמץ כדי להגדיל את הפרודוקטיביות שלך פי 100.",
    part3:
      "PlexusAI יכול לפעול באופן מקומי לחלוטין על המחשב שלך עם מעט עלויות ביצוע שאתה אפילו לא תבחין בהן! לא נדרש GPU. התקנה בענן ובמקום היא זמינה גם כן.\nמערכת הכלים של AI הופכת חזקה יותר מדי יום. PlexusAI הופכת את השימוש בה פשוט.",
  ...
  api: {
    title: "מפתחות API",
    description:
      "מפתחות API מאפשרים לבעלים לגשת ולתפעל מופע PlexusAI זה באופן תכנותי.",
  ...
  llm: {
    title: "העדפת LLM",
    description:
      "אלה אישורי ההרשאה וההגדרות עבור ספק צ'אט והטבעה LLM המועדף עליך. חשוב שאישורי ההרשאה יהיו עדכניים ונכונים אחרת PlexusAI לא תוכל לפעול כראוי.",
    provider: "ספק LLM",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "ספק התמלול",
    "warn-start":
      "שימוש בדגם Whisper מקומי במחשבים עם זיכרון RAM או מעבד מוגבלים יכול לעצור את PlexusAI בעת עיבוד קבצי מדיה.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "הטבעה היא תהליך הפיכת טקסט לווקטורים. אישורי הרשאה אלה נדרשים כדי להפוך את הקבצים והבקשות שלך לפורמט ש-PlexusAI יכול להשתמש בו לעיבוד.",
    provider: {
      title: "ספק הטבעה",
      description:
        "אין צורך בהגדרה בעת שימוש במנוע ההטבעה המקורי של PlexusAI.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "אלה אישורי ההרשאה וההגדרות עבור אופן פעולתו של מופע PlexusAI שלך. חשוב שאישורי ההרשאה יהיו עדכניים ונכונים.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "הגן על מופע PlexusAI שלך באמצעות סיסמה. אם תשכח את הסיסמה הזו אין שום דרך להחזיר אותה אז וודא שאתה שומר את הסיסמה הזו.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "זו הקונפיגורציה שלך עבור אופן הטיפול בנתונים שלך על ידי ספקי צד שלישי מחוברים ו-PlexusAI.",
    llm: "בחירת LLM",
