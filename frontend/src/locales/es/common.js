...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Bienvenido a PlexusAI, una herramienta de inteligencia artificial de código abierto creada por Mintplex Labs que convierte cualquier cosa en un chatbot entrenado con el que puedes consultar y conversar. PlexusAI es un software BYOK (bring-your-own-keys), por lo que no hay suscripciones, tarifas ni cargos por este software, salvo por los servicios que deseas utilizar.",
    part2:
      "PlexusAI es la forma más sencilla de integrar productos de inteligencia artificial potentes como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB y otros servicios en un paquete ordenado, sin complicaciones, para aumentar tu productividad en un 100x.",
    part3:
      "PlexusAI puede ejecutarse completamente en tu máquina local con poco impacto, ¡ni siquiera notarás que está ahí! No se necesita GPU. También está disponible la instalación en la nube y en instalaciones locales.\nEl ecosistema de herramientas de inteligencia artificial se vuelve más poderoso cada día. PlexusAI facilita su uso.",
  ...
  general: {
    ...
    message: {
      ...
      heading: "Explícame",
      body: "los beneficios de PlexusAI",
    },
    pfp: {
  ...
  api: {
    title: "Claves API",
    description:
      "Las claves API permiten al titular acceder y gestionar programáticamente esta instancia de PlexusAI.",
  ...
  llm: {
    ...
    description:
      "Estas son las credenciales y configuraciones para tu proveedor preferido de chat y incrustación de LLM. Es importante que estas claves estén actualizadas y correctas, de lo contrario PlexusAI no funcionará correctamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "El uso del modelo local Whisper en máquinas con RAM o CPU limitadas puede bloquear PlexusAI al procesar archivos multimedia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "La incrustación es el proceso de convertir texto en vectores. Estas credenciales son necesarias para convertir tus archivos y prompts en un formato que PlexusAI pueda usar para procesar.",
    provider: {
      title: "Proveedor de incrustación",
      description:
        "No se requiere configuración cuando se utiliza el motor de incrustación nativo de PlexusAI.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "Estas son las credenciales y configuraciones para cómo funcionará tu instancia de PlexusAI. Es importante que estas claves estén actualizadas y correctas.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protege tu instancia de PlexusAI con una contraseña. Si olvidas esta contraseña, no hay método de recuperación, así que asegúrate de guardar esta contraseña.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Esta es tu configuración para cómo los proveedores de terceros conectados y PlexusAI manejan tus datos.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed:
        "¡Estás en camino de convertirte en un experto en PlexusAI!",
      dismiss: "cerrar",
      tasks: {
        create_workspace: {
