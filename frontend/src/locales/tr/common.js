...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "PlexusAI'e hoş geldiniz. PlexusAI, Mintplex Labs tarafından geliştirilen açık kaynaklı bir yapay zeka aracıdır ve her şeyi, sorgulayabileceğiniz ve sohbet edebileceğiniz eğitimli bir chatbota dönüştürür. PlexusAI, BYOK (kendi anahtarlarınızı getirin) yazılımıdır; bu nedenle, kullanmak istediğiniz hizmetler dışında herhangi bir abonelik, ücret ya da ek masraf yoktur.",
    part2:
      "PlexusAI, OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB ve benzeri güçlü yapay zeka ürünlerini zahmetsizce, düzenli bir paket içinde bir araya getirmenin en kolay yoludur; böylece verimliliğinizi 100 kat artırabilirsiniz.",
    part3:
      "PlexusAI tamamen yerel olarak makinenizde çok az kaynakla çalışabilir—orada olduğunu bile fark etmezsiniz! GPU gerekmez. Bulut veya şirket içi (on-premises) kurulum da mevcuttur.\nYapay zeka araç ekosistemi her geçen gün daha da güçleniyor. PlexusAI bu gücü kolayca kullanmanızı sağlar.",
  ...
  api: {
    ...
    description:
      "API anahtarları, bu PlexusAI örneğine programatik olarak erişmeye ve yönetmeye olanak tanır.",
  ...
  llm: {
    title: "LLM Tercihi",
    description:
      "Bu, tercih ettiğiniz LLM sohbet ve gömme sağlayıcısının kimlik bilgileri ile ayarlarıdır. Bu anahtarların güncel ve doğru olması önemlidir; aksi takdirde PlexusAI doğru çalışmayacaktır.",
  ...
  transcription: {
    ...
    "warn-start":
      "Sınırlı RAM veya CPU'ya sahip makinelerde yerel Whisper modelini kullanmak, medya dosyalarını işlerken PlexusAI'nin duraksamasına neden olabilir.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Gömme, metni vektörlere dönüştürme sürecidir. Dosyalarınızın ve komutlarınızın işlenebilmesi için PlexusAI, bu kimlik bilgilerine ihtiyaç duyar.",
    provider: {
      title: "Embedding Sağlayıcısı",
      description:
        "PlexusAI'nin yerel gömme motoru kullanıldığında ek bir kurulum gerekmez.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "PlexusAI örneğinizin nasıl çalışacağını belirleyen kimlik bilgileri ve ayarları burada bulunur. Bu anahtarların güncel ve doğru olması önemlidir.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "PlexusAI örneğinizi bir şifre ile koruyun. Bu şifreyi unutmanız hâlinde kurtarma yöntemi yoktur, bu yüzden mutlaka güvende saklayın.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Bağlantılı üçüncü taraf sağlayıcılarla ve PlexusAI ile verilerinizin nasıl ele alındığını burada yapılandırabilirsiniz.",
    llm: "LLM Seçimi",
