...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PlexusAI töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust.",
    },
    userSetup: {
    ...
    survey: {
      title: "Tere tulemast PlexusAI-i",
      description:
        "Aita meil PlexusAI sinu vajadustele vastavaks kujundada. Valikuline.",
      email: "Mis on su e-post?",
      useCase: "Milleks kasutad PlexusAI-i?",
      useCaseWork: "Töö jaoks",
      useCasePersonal: "Isiklikuks kasutuseks",
      useCaseOther: "Muu",
      comment: "Kust kuulsid PlexusAI-ist?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Loo esimene tööruum ja alusta PlexusAI-iga.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Tere tulemast PlexusAI-i! See on Mintplex Labsi avatud lähtekoodiga AI-tööriist, mis muudab kõik failid koolitatud juturobotiks, kellega saad vestelda. PlexusAI on BYOK-tarkvara, seega puudub igasugune tellimus- või litsentsitasu, välja arvatud kasutatavate teenuste kulud.",
    part2:
      "PlexusAI on lihtsaim viis kombineerida võimsad AI-teenused nagu OpenAI, GPT-4, LangChain, PineconeDB, ChromaDB jpt ilma vaevata, tõstes sinu produktiivsust kordades.",
    part3:
      "PlexusAI võib töötada täielikult lokaalselt sinu masinas minimaalse ressursikasutusega – GPU-d pole vaja. Samuti on saadaval pilve- ja kohapealsed paigaldised.\nAI-ökosüsteem muutub iga päevaga võimekamaks ja PlexusAI teeb selle kasutamise lihtsaks.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Oled teel PlexusAI-i eksperdiks saama!",
      dismiss: "sulge",
      tasks: {
        create_workspace: {
          title: "Loo tööruum",
  ...
  customization: {
    interface: {
      ...
      description: "Sea PlexusAI-i UI eelistused.",
    },
    branding: {
      title: "Bränding ja valgesildistamine",
      description: "Valgesildista oma PlexusAI kohandatud brändinguga.",
    },
    chat: {
      title: "Vestlus",
    ...
    items: {
      ...
      "display-language": {
        title: "Kuvakeel",
        description:
          "Vali keel, milles PlexusAI UI kuvatakse (kui tõlge on olemas).",
      },
      logo: {
        title: "Brändi logo",
  ...
  api: {
    title: "API võtmed",
    description:
      "API võtmed võimaldavad programmipõhiselt hallata seda PlexusAI instantsi.",
  ...
  llm: {
    title: "LLM-i eelistus",
    description:
      "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul PlexusAI ei tööta.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et PlexusAI saaks sinu failid ja päringud töödelda.",
    provider: {
      title: "Embedding-i pakkuja",
      description:
        "PlexusAI-i sisseehitatud embedding-mootor ei vaja seadistust.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "Siin on seaded, kuidas PlexusAI töötab. Vale seadistus võib põhjustada tõrkeid.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Konfiguratsioon kolmandate osapoolte ja PlexusAI-i andmekäitluse kohta.",
    llm: "LLM-i valik",
