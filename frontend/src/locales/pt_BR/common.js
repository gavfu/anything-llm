...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PlexusAI funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao PlexusAI",
      description: "Ajude-nos a melhorar o PlexusAI. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o PlexusAI?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o PlexusAI?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Crie seu primeiro workspace e comece a usar o PlexusAI.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Bem-vindo ao PlexusAI, uma ferramenta de IA open-source da Mintplex Labs que transforma qualquer conteúdo em um chatbot treinado. PlexusAI é um software BYOK (bring-your-own-keys), sem taxas ou assinaturas.",
    part2:
      "PlexusAI é a maneira mais fácil de integrar poderosas ferramentas de IA como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e outros serviços em um pacote simples.",
    part3:
      "PlexusAI pode rodar localmente na sua máquina com baixo consumo de recursos. Sem GPU necessária. Disponível para instalação na nuvem ou on-premises.\nO ecossistema de IA evolui rapidamente. PlexusAI facilita seu uso.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed:
        "Você está no caminho para se tornar um expert em PlexusAI!",
      dismiss: "fechar",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do PlexusAI",
    },
    pfp: {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do PlexusAI com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o PlexusAI.",
  ...
  embedding: {
    ...
    provider: {
      ...
      description:
        "Nenhuma configuração é necessária ao usar o mecanismo nativo do PlexusAI.",
    },
  },
  text: {
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o PlexusAI lidam com seus dados.",
    llm: "Seleção de LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do PlexusAI. Não são compartilhados com terceiros.",
    },
    pinning: {
