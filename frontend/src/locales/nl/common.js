...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Welkom bij PlexusAI, PlexusAI is een open-source AI-tool van Mintplex Labs die alles omzet in een getrainde chatbot waarmee je kunt vragen en chatten. PlexusAI is een BYOK (bring-your-own-keys) software, dus er is geen abonnement, vergoeding of kosten voor deze software buiten de diensten die je ermee wilt gebruiken.",
    part2:
      "PlexusAI is de eenvoudigste manier om krachtige AI-producten zoals OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB en andere diensten samen te voegen in een net pakket zonder gedoe om je productiviteit met 100x te verhogen.",
    part3:
      "PlexusAI kan volledig lokaal op je machine draaien met weinig overhead, je merkt niet eens dat het er is! Geen GPU nodig. Cloud en on-premises installatie is ook beschikbaar.\nHet AI-tooling ecosysteem wordt elke dag krachtiger. PlexusAI maakt het gemakkelijk te gebruiken.",
  ...
  general: {
    ...
    message: {
      ...
      heading: "Leg me uit",
      body: "de voordelen van PlexusAI",
    },
    pfp: {
  ...
  api: {
    title: "API-sleutels",
    description:
      "API-sleutels stellen de houder in staat om deze PlexusAI-instantie programmatisch te openen en beheren.",
  ...
  llm: {
    title: "LLM Voorkeur",
    description:
      "Dit zijn de inloggegevens en instellingen voor je voorkeurs LLM-chat & inbeddingprovider. Het is belangrijk dat deze sleutels actueel en correct zijn, anders zal PlexusAI niet goed werken.",
  ...
  transcription: {
    ...
    "warn-start":
      "Het gebruik van het lokale fluistermodel op machines met beperkte RAM of CPU kan PlexusAI vertragen bij het verwerken van mediabestanden.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Inbedding is het proces van het omzetten van tekst in vectoren. Deze inloggegevens zijn vereist om je bestanden en prompts om te zetten naar een formaat dat PlexusAI kan gebruiken om te verwerken.",
    provider: {
      title: "Inbedding Provider",
      description:
        "Er is geen instelling vereist bij gebruik van de ingebouwde inbeddingengine van PlexusAI.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "Dit zijn de inloggegevens en instellingen voor hoe je PlexusAI-instantie zal functioneren. Het is belangrijk dat deze sleutels actueel en correct zijn.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Bescherm je PlexusAI-instantie met een wachtwoord. Als je dit vergeet, is er geen herstelmethode, dus zorg ervoor dat je dit wachtwoord opslaat.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Dit is je configuratie voor hoe verbonden derden en PlexusAI je gegevens verwerken.",
    llm: "LLM Selectie",
