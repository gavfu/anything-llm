...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Benvenuti in PlexusAI, PlexusAI è uno strumento di intelligenza artificiale open source di Mintplex Labs che trasforma qualsiasi cosa in un chatbot addestrato con cui puoi effettuare query e chattare. PlexusAI è un software BYOK (bring-your-own-keys), quindi non ci sono abbonamenti, commissioni o costi per questo software al di fuori dei servizi che vuoi utilizzare.",
    part2:
      "PlexusAI è il modo più semplice per mettere insieme potenti prodotti di intelligenza artificiale come OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e altri servizi in un pacchetto ordinato e senza problemi per aumentare la tua produttività di 100 volte.",
    part3:
      "PlexusAI può essere eseguito completamente in locale sulla tua macchina con un overhead minimo, non ti accorgerai nemmeno che c'è! Non serve GPU. Sono disponibili anche installazioni cloud e on-premise.\nL'ecosistema degli strumenti di intelligenza artificiale diventa ogni giorno più potente. PlexusAI lo rende facile da usare.",
  ...
  api: {
    title: "Chiavi API",
    description:
      "Le chiavi API consentono al titolare di accedere e gestire in modo programmatico questa istanza PlexusAI.",
  ...
  llm: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il tuo provider di chat e embedding LLM preferito. È importante che queste chiavi siano aggiornate e corrette, altrimenti PlexusAI non funzionerà correttamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilizzo del modello whisper locale su macchine con RAM o CPU limitate può bloccare PlexusAI durante l'elaborazione di file multimediali.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'embedding è il processo di trasformazione del testo in vettori. Queste credenziali sono necessarie per trasformare i file e i prompt in un formato che PlexusAI può utilizzare per l'elaborazione.",
    provider: {
      title: "Provider di embedding",
      description:
        "Non è richiesta alcuna configurazione quando si utilizza il motore di embedding nativo di PlexusAI.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il funzionamento della tua istanza PlexusAI. È importante che queste chiavi siano aggiornate e corrette.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Proteggi la tua istanza PlexusAI con una password. Se la dimentichi, non esiste un metodo di recupero, quindi assicurati di salvare questa password.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Questa è la tua configurazione per il modo in cui i provider terzi connessi e PlexusAI gestiscono i tuoi dati.",
    llm: "Selezione LLM",
