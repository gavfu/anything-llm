...
function useCommunityHubAuthentication() {
  ...
  async function disconnectHub() {
    ...
    try {
      ...
      setHasChanges(false);
      showToast("Disconnected from PlexusAI Community Hub", "success");
          ...
          <div className="w-full flex flex-col gap-y-1 pb-6 border-white light:border-theme-sidebar-border border-b-2 border-opacity-10">
            <div className="items-center">
              <p className="text-lg leading-6 font-bold text-theme-text-primary">
                Your PlexusAI Community Hub Account
              </p>
            </div>
            <p className="text-xs leading-[18px] font-base text-theme-text-secondary">
              Connecting your PlexusAI Community Hub account allows you to
              access your <b>private</b> PlexusAI Community Hub items as well
              as upload your own items to the PlexusAI Community Hub.
            </p>
          </div>
              ...
              <div className="flex flex-col gap-y-2">
                <div className="gap-x-2 flex items-center">
                  ...
                  <h1 className="text-lg font-semibold">
                    Why connect my PlexusAI Community Hub account?
                  </h1>
                </div>
                <p className="text-sm text-theme-text-secondary">
                  Connecting your PlexusAI Community Hub account allows you
                  to pull in your <b>private</b> items from the PlexusAI
                  Community Hub as well as upload your own items to the
                  PlexusAI Community Hub.
                  <br />
                  <br />
                  <i>
                    You do not need to connect your PlexusAI Community Hub
                    account to pull in public items from the PlexusAI
                    Community Hub.
                  </i>
                </p>
              </div>
          ...
          <div className="mt-6 mb-12">
            <div className="flex flex-col w-full max-w-[400px]">
              ...
              <input
                ...
                placeholder="Enter your PlexusAI Hub API key"
              />
              <div className="flex items-center justify-between mt-2">
                <p className="text-theme-text-secondary text-xs">
                  ...
                  >
                    PlexusAI Community Hub profile page
                  </a>
                  .
                </p>
                {!!originalConnectionKey && (
