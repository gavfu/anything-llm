...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of PlexusAI",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    name: "PlexusAI Embedder",
    description: [
      "Your document text is embedded privately on this instance of PlexusAI",
    ],
...
export const FALLBACKS = {
  LLM: (provider) => ({
    name: "Unknown",
    description: [
      `"${provider}" has no known data handling policy defined in PlexusAI`,
    ],
    logo: AnythingLLMIcon,
  }),
  EMBEDDING: (provider) => ({
