...
function apiDocumentEndpoints(app) {
  ...
  app.post(
    ...
    #swagger.description = 'Upload a new file to PlexusAI to be parsed and prepared for embedding.'
    #swagger.requestBody = {
  ...
  app.post(
    ...
    async (request, response) => {
      /*
      #swagger.tags = ['Documents']
      #swagger.description = 'Upload a new file to a specific folder in PlexusAI to be parsed and prepared for embedding. If the folder does not exist, it will be created.'
  ...
  app.post(
    ...
    async (request, response) => {
      /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Upload a valid URL for PlexusAI to scrape and prepare for embedding. Optionally, specify a comma-separated list of workspace slugs to embed the document into post-upload.'
    #swagger.requestBody = {
              ...
              documents: [
                {
                  ...
                  "wordCount": 252,
                  "pageContent": "PlexusAI is the best....",
      ...
      content: {
        "application/json": {
          schema: {
            type: 'object',
            example: {
              "textContent": "This is the raw text that will be saved as a document in PlexusAI.",
              "addToWorkspaces": "workspace1,workspace2",
              "metadata": {
  ...
  app.get("/v1/document/:docName", [validApiKey], async (request, response) => {
    /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Get a single document by its unique PlexusAI document name'
