# How to setup Pinecone Vector Database for PlexusAI
...
**Note:** [Namespaces are not supported in `gcp-starter` environments](https://docs.pinecone.io/docs/namespaces) and are required to work with PlexusAI.
