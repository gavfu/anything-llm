...
/**
 * An interface to the PlexusAI Community Hub external API.
 */
const CommunityHub = {
   ...
   * so we can unzip and import them to the PlexusAI instance.
  ...
  /**
   * Apply an item to the PlexusAI instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the PlexusAI instance by downloading the zip file and importing it.
