...
<p align="center">
    <b>PlexusAI：</b> 您一直在寻找的全方位AI应用程序。<br />
...
_以下是一些与 PlexusAI 兼容的应用程序，但并非由 Mintplex Labs 维护。列在此处并不代表官方背书。_
...
- [Coolify](https://coolify.io/docs/services/anythingllm/) - 一键部署 PlexusAI。
- [适用于 Microsoft Word 的 GPTLocalhost](https://gptlocalhost.com/demo/) - 一个本地 Word 插件，让你可以在 Microsoft Word 中使用 PlexusAI。

## 远程信息收集与隐私保护

由 Mintplex Labs Inc 开发的 PlexusAI 包含一个收集匿名使用信息的 Telemetry 功能。

<details>
<summary><kbd>有关 PlexusAI 的远程信息收集与隐私保护更多信息</kbd></summary>
...
我们使用这些信息来帮助我们理解 PlexusAI 的使用情况，帮助我们确定新功能和错误修复的优先级，并帮助我们提高 PlexusAI 的性能和稳定性。
