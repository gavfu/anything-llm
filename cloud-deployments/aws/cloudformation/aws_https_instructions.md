...
## Step 7: Create simple http proxy configuration for PlexusAI 
These instructions are for CLI configuration and assume you are logged in to EC2 instance as the ec2-user.
...
3. Navigate to http://FQDN in a browser and you should be proxied to the PlexusAI web UI.
...
2. Navigate to https://FQDN in a browser and you should be proxied to the PlexusAI web UI.
